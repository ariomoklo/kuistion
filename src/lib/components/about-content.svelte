<p><b class="underline underline-offset-4">kuistion</b> is a mini game dedicated to build bond between team with exchanging question and experience!</p>
...
<div class="prose text-token">
    ...
    <ul>
        ...
        <li>Incorrect answer +0 point</li>
        <li>For every correct answer, question maker get -1 point</li>
        <li>For every incorrect answer, question maker get +1 point</li>
    </ul>
    <p>The player with the most point on the end win!</p>
</div>